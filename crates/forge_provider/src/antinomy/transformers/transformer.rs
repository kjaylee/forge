...
/// A trait for transforming AntinomyRequest based on model-specific
/// requirements
pub trait Transformer {
    ...
    fn when_model_matches_condition(
        ...
        pattern: &str,
        matches: bool,
    ) -> When<Self, impl Fn(&AntinomyRequest) -> bool>
    where
        Self: Sized,
    {
        let regex =
    ...
    fn when_model(self, pattern: &str) -> When<Self, impl Fn(&AntinomyRequest) -> bool>
    where
        Self: Sized,
    {
    ...
    fn except_when_model(self, pattern: &str) -> When<Self, impl Fn(&AntinomyRequest) -> bool>
    where
        Self: Sized,
    {
    ...
    fn when<F: Fn(&AntinomyRequest) -> bool>(self, condition: F) -> When<Self, F>
    where
        Self: Sized,
    {
        When(self, condition)
...
mod tests {
    ...
    fn test_when_model_matches_condition_true() {
        ...
        let request = AntinomyRequest::default().model(ModelId::new("anthropic/claude-3"));
    ...
    fn test_when_model_matches_condition_no_match() {
        // Fixture
        let transformer = TestTransformer { prefix: "prefix-".to_string() };
        let request = AntinomyRequest::default().model(ModelId::new("openai/gpt-4"));
    ...
    fn test_except_when_model() {
        ...
        let request1 = AntinomyRequest::default().model(ModelId::new("anthropic/claude-3"));
        ...
        let request2 = AntinomyRequest::default().model(ModelId::new("openai/gpt-4"));
    ...
    fn test_combine() {
        ...
        let request = AntinomyRequest::default().model(ModelId::new("model"));
    ...
    fn test_when() {
        ...
        let request1 = AntinomyRequest::default().model(ModelId::new("model"));
        ...
        let transformer2 = TestTransformer { prefix: "prefix-".to_string() };
        let request2 = AntinomyRequest::default().model(ModelId::new("model"));
    ...
    fn test_when_model_no_model() {
        // Fixture
        let transformer = TestTransformer { prefix: "prefix-".to_string() };
        let request = AntinomyRequest::default(); // No model set
