...
/// extracts text from PDF and DOCX files, and supports reading Image files,
/// preserving the original formatting. Returns the content as a string. For 
/// files larger than 2,000 lines, the tool automatically returns only the 
/// first 2,000 lines. You should always rely on this default behavior and 
...
/// limit will result in an error. Binary files are automatically detected and 
/// rejected.
