...
// Add a test so for gpt-4o-mini which whill return mutliple toolcalls in one
// message and runs the results and respond with summary of values produced by
// the toolcalls
#[tokio::test]
